        ...
        Begin Section
            ...
            Begin
                ...
                Begin CommandButton
                    ...
                    Height =720
                    TabIndex =375
                    Name ="btnRunCanopyGapChecks"
                    Caption ="Check Canopy Gaps"
                    StatusBarText ="Check Canopy Gap Data!"
                    OnClick ="[Event Procedure]"
                    ControlTipText ="Check Canopy Gap Data!"
...
' -------------------------------------------------------------------------------------------------
' Sub:          btnRunCanopyGapChecks_Click
' Description:  Run canopy gap checks button click actions
' Assumptions:  -
' Parameters:   -
' Returns:      -
' Throws:       -
' References:   -
' Source/date:  Helen Thomas, 7/4/2018
' Adapted:      -
' Revisions:
' -------------------------------------------------------------------------------------------------
Private Sub btnRunCanopyGapChecks_Click()
...
Dim tid As Variant
  ...
  ' Retrieve canopy gap records with non-null start and end to check for overlapping gaps
  Set rs = GetRecords("s_canopy_gaps_non_null_start_end")

  ' Exit if there are not enough records
  If rs.BOF And rs.EOF Then
    MsgBox "No canopy gap records found."
    GoTo Exit_Handler
  End If
  rs.MoveLast
  rs.MoveFirst
  If rs.RecordCount <= 1 Then
    MsgBox "More than one canopy gap record is required to run overlapping canopy gap check."
    GoTo Exit_Handler
  End If
  ...
  Do Until rs.EOF Or rsNext.EOF
    ' If gap end greater than or equal to next gap start, write to result file
    If rs!Gap_End >= rsNext!Start Then
        rsResult.AddNew
  ...
  ' Set parameter
  SetTempVar "TransectID", tid
  ' Retrieve results of query that combines all canopy gap QC check results
  Set rs = GetRecords("qc_canopy_gap_checks")
  
  If rs.BOF And rs.EOF Then
    MsgBox "No canopy gap issues found!"
  Else
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - btnRunCanopyGapChecks_Click[fsub_Canopy_Gap])"
    End Select
    Resume Exit_Handler
End Sub
...
Private Sub F341_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F341") = 1 Then
    Me!F341 = Null
  End If
End Sub

Private Sub F342_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F342") = 1 Then
    Me!F342 = Null
  End If
End Sub

Private Sub F343_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F343") = 1 Then
    Me!F343 = Null
  End If
End Sub

Private Sub F344_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F344") = 1 Then
    Me!F344 = Null
  End If
End Sub

Private Sub F345_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F345") = 1 Then
    Me!F345 = Null
  End If
End Sub

Private Sub F346_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F346") = 1 Then
    Me!F346 = Null
  End If
End Sub

Private Sub F347_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F347") = 1 Then
    Me!F347 = Null
  End If
End Sub

Private Sub F348_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F348") = 1 Then
    Me!F348 = Null
  End If
End Sub

Private Sub F349_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F349") = 1 Then
    Me!F349 = Null
  End If
End Sub
...
Private Sub F350_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F350") = 1 Then
    Me!F350 = Null
  End If
End Sub

Private Sub F351_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F351") = 1 Then
    Me!F351 = Null
  End If
End Sub

Private Sub F352_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F352") = 1 Then
    Me!F352 = Null
  End If
End Sub

Private Sub F353_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F353") = 1 Then
    Me!F353 = Null
  End If
End Sub

Private Sub F354_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F354") = 1 Then
    Me!F354 = Null
  End If
End Sub

Private Sub F355_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F355") = 1 Then
    Me!F355 = Null
  End If
End Sub

Private Sub F356_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F356") = 1 Then
    Me!F356 = Null
  End If
End Sub

Private Sub F357_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F357") = 1 Then
    Me!F357 = Null
  End If
End Sub

Private Sub F358_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F358") = 1 Then
    Me!F358 = Null
  End If
End Sub

Private Sub F359_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F359") = 1 Then
    Me!F359 = Null
  End If
End Sub
...
Private Sub F360_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F360") = 1 Then
    Me!F360 = Null
  End If
End Sub

Private Sub F361_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F361") = 1 Then
    Me!F361 = Null
  End If
End Sub

Private Sub F362_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F362") = 1 Then
    Me!F362 = Null
  End If
End Sub

Private Sub F363_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F363") = 1 Then
    Me!F363 = Null
  End If
End Sub

Private Sub F364_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F364") = 1 Then
    Me!F364 = Null
  End If
End Sub

Private Sub F365_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F365") = 1 Then
    Me!F365 = Null
  End If
End Sub

Private Sub F366_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F366") = 1 Then
    Me!F366 = Null
  End If
End Sub

Private Sub F367_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F367") = 1 Then
    Me!F367 = Null
  End If
End Sub

Private Sub F368_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F368") = 1 Then
    Me!F368 = Null
  End If
End Sub

Private Sub F369_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F369") = 1 Then
    Me!F369 = Null
  End If
End Sub
...
Private Sub F370_AfterUpdate()
  If UpdateCanopyGaps(Me!Transect_ID, "F370") = 1 Then
    Me!F370 = Null
  End If
End Sub
