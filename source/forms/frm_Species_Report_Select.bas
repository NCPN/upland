...
On Error GoTo Err_Handler
    ...
    'add an index & primary key to improve report performance
    Dim strIdxSQL As String, strKeySQL As String
    
    'strIdxSQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Complete ADD COLUMN ID AutoIncrement"
    ...
    'strKeySQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Complete ADD CONSTRAINT ID Primary Key(ID)"
'    strKeySQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Complete ADD CONSTRAINT pkParkPlotSpeciesYear Primary Key(ParkPlotSpecies, Year)"
'    CurrentDb.Execute strKeySQL
    ...
    'strIdxSQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Rollup ADD COLUMN ID AutoIncrement"
    'CurrentDb.Execute strIdxSQL
    strIdxSQL = "CREATE INDEX idxParkPlotSpeciesYears ON temp_Sp_Rpt_by_Park_Rollup (ParkPlotSpecies, SpeciesYears)"
    CurrentDb.Execute strIdxSQL

'    strKeySQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Rollup ADD CONSTRAINT ID Primary Key(ID)"
'     strKeySQL = "ALTER TABLE temp_Sp_Rpt_by_Park_Rollup ADD CONSTRAINT pkParkPlotSpeciesYears Primary Key(ParkPlotSpecies, SpeciesYears)"
'    CurrentDb.Execute strKeySQL
