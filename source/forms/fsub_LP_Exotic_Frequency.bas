...
Begin Form
    ...
    Caption ="fsub_LP_Exotic_Frequency"
            ...
            Begin
                Begin TextBox
                    ...
                    ConditionalFormat = Begin
                        0x0100000058020000030000000100000000000000000000006e00000001000000 ,
                        0x00000000ffff000001000000000000006f000000dd0000000100000000000000 ,
                        0xffffff000100000000000000de000000fb0000000100000000000000ffffff00 ,
                        ...
                        0x74006900630073005d003d00540072007500650000000000
                    End
                    ...
                    ConditionalFormat14 = Begin
                        ...
                        0x00000000ffffff001c0000005b0050006100720065006e0074005d002e005b00 ,
                        0x6300620078004e006f00450078006f0074006900630073005d003d0054007200 ,
                ...
                Begin ComboBox
                    ...
                    ConditionalFormat = Begin
                        ...
                        0xffff0000010000000000000093000000b60000000100000000000000ffffff00 ,
                        ...
                        0x4e006f00450078006f0074006900630073005d002e00560061006c0075006500 ,
                        0x3d00540072007500650000000000
                    End
                    Name ="Species"
                    ControlSource ="Species"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT *  FROM  (SELECT qryU_Top_Canopy.Master_PLANT_Code, qryU_Top_Canopy.LU_Co"
                        "de AS LUcode, qryU_Top_Canopy.Utah_Species,  qryU_Top_Canopy.Nativity   FROM qry"
                        "U_Top_Canopy  WHERE (((qryU_Top_Canopy.Utah_Species) Is Not Null) AND ((qryU_Top"
                        "_Canopy.[Nativity])='NonNative'))  )    UNION ALL  (SELECT tbl_Unknown_Species.U"
                        "nknown_Code, tbl_Unknown_Species.Unknown_Code AS LUcode,   tbl_Unknown_Species.P"
                        "lant_Type + \" - \" + tbl_Unknown_Species.Plant_Description, NULL AS Nativity FR"
                        "OM tbl_Unknown_Species ORDER BY tbl_Unknown_Species.Unknown_Code) ORDER BY LUcod"
                        "e;"
                    ...
                    ConditionalFormat14 = Begin
                        ...
                        0x0031002c00300029000000000000000000000000000000000000000000000100 ,
                        0x0000000000000100000000000000ffffff00220000005b005000610072006500 ,
                        0x6e0074005d002e005b006300620078004e006f00450078006f00740069006300 ,
                        0x73005d002e00560061006c00750065003d005400720075006500000000000000 ,
...
' =================================
' MODULE:       Form_fsub_Exotic_Frequency
' Level:        Form module
' Version:      1.02
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_Load[Form_fsub_Exotic_Frequency])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ButtonDelete_Click[Form_fsub_LP_Exotic_Frequency])"
    End Select
    Resume Exit_Handler
End Sub
