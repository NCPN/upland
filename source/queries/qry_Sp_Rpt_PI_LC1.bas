...
Begin Joins
    ...
    Expression ="tbl_LP_Intercept.LCS1 = tlu_NCPN_Plants.Master_PLANT_Code"
    Flag =1
...
dbBinary "GUID" = Begin
    0x3d543e473c41354dba4d1d77ce358bb5
End
dbMemo "Filter" ="([qry_Sp_Rpt_PI_LC1].[Utah_Species] Is Null OR [qry_Sp_Rpt_PI_LC1].[Utah_Species"
    "]=\"\")"
...
Begin
    ...
    Begin
        ...
        dbLong "AggregateType" ="-1"
        dbBinary "GUID" = Begin
            0xeaf97a8ca28be346a0198437c5a91369
        End
    End
End
Begin
