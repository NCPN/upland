...
Begin Joins
    ...
    Expression ="tbl_LP_Intercept.LCS4 = tlu_NCPN_Plants.Master_PLANT_Code"
    Flag =1
...
dbBinary "GUID" = Begin
    0x4d40a743fb1d0a4c8841914bbcbe6f70
End
dbMemo "Filter" ="([qry_Sp_Rpt_PI_LC4].[Utah_Species] Is Null OR [qry_Sp_Rpt_PI_LC4].[Utah_Species"
    "]=\"\")"
...
Begin
    ...
    Begin
        ...
        dbLong "AggregateType" ="-1"
        dbBinary "GUID" = Begin
            0xaedb4267d80ed542b527084e06e8e460
        End
    End
End
Begin
