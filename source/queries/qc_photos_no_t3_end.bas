dbMemo "SQL" ="SELECT qc_plot_visits.Unit_Code, qc_plot_visits.Plot_ID, qc_plot_visits.Start_Da"
    ...
    "s_t3_end ON (qc_plot_visits.Unit_Code = qc_photos_t3_end.Unit_Code) AND (qc_plot"
    "_visits.Plot_ID = qc_photos_t3_end.Plot_ID) AND (qc_plot_visits.Start_Date = qc_"
    "photos_t3_end.Start_Date) AND (qc_plot_visits.Vegetation_Type = qc_photos_t3_end"
    ...
    "Vegetation_Type)=\"oak scrub\") \015\012AND ((qc_photos_t3_end.Unit_Code) Is Nul"
