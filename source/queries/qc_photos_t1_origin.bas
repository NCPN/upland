dbMemo "SQL" ="SELECT tbl_Locations.Unit_Code, tbl_Locations.Plot_ID, tbl_Events.Start_Date, tb"
    ...
    "\015\012WHERE (((tbl_Photos.Transect)=\"T1 - origin\") AND ((tbl_Photos.Location"
    ")=-3))\015\012ORDER BY tbl_Locations.Unit_Code, tbl_Locations.Plot_ID, tbl_Event"
    "s.Start_Date;\015\012"
dbMemo "Connect" =""
